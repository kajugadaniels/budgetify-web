        ...
        <div className="relative overflow-hidden rounded-full border border-white/10 bg-[radial-gradient(circle_at_top,rgba(199,191,167,0.18),transparent_36%),linear-gradient(180deg,rgba(23,28,34,0.96),rgba(11,13,16,0.98))] px-2 py-2 shadow-[0_24px_70px_rgba(0,0,0,0.42)] backdrop-blur-[28px] md:px-3 md:py-3">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <Link
              ...
              className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/[0.045] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition-transform duration-300 motion-safe:hover:-translate-y-0.5 md:h-14 md:w-14"
            >
              <Image
                src="/logo_color.png"
                alt="Budgetify"
            ...
            <div className="min-w-0 flex-1 overflow-x-auto [scrollbar-width:none]">
              ...
              return (
                <Link
                  ...
                  href={href}
                  className={cn(
                    "group flex h-12 shrink-0 items-center justify-center gap-1.5 rounded-full px-3 py-2 text-center transition-[transform,background-color,border-color,box-shadow,color] duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/45 motion-safe:hover:-translate-y-0.5 md:h-14 md:gap-2 md:px-4",
                    isActive
